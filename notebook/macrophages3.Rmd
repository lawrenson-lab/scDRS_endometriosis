...
p1<-plot_grid(p1,sf9C,sf9D,ncol=3,labels = c('','f','g'))
p2<-plot_grid(sf10,NULL,NULL,ncol=3,labels = c('h','i','j'))
ggsave("m_fig3.pdf",height = 14,width=14,device = cairo_pdf,
       plot_grid(p0,p1,p3,nrow = 3,rel_heights = c(.3,.4,.3)))
